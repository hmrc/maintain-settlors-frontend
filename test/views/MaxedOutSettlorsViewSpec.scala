...
import views.html.MaxedOutSettlorsView

class MaxedOutSettlorsViewSpec extends OptionsViewBehaviours with TabularDataViewBehaviours {

  val messageKeyPrefix = "addASettlor.count"
  ...
  "MaxedOutSettlorsView" when {
    ...
    "migrating from non-taxable to taxable" when {
      ...
      "there are many maxed out beneficiaries" must {
        ...
        behave like dynamicTitlePage(view, messageKeyPrefix, max.toString)
