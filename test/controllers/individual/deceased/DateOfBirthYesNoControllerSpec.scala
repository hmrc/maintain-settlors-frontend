...
import pages.individual.deceased.{DateOfBirthYesNoPage, NamePage}
...
class DateOfBirthYesNoControllerSpec extends SpecBase with MockitoSugar {
  ...
  val form: Form[Boolean] = formProvider.withPrefix("deceasedSettlor.dateOfBirthYesNo")

  lazy val dateOfBirthYesNoRoute: String = routes.DateOfBirthYesNoController.onPageLoad().url
