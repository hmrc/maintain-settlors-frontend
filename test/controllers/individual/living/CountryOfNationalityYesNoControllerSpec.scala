...
import pages.individual.living.{CountryOfNationalityYesNoPage, NamePage}
import play.api.data.Form
import play.api.inject.bind
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.individual.living.CountryOfNationalityYesNoView

class CountryOfNationalityYesNoControllerSpec extends SpecBase {

  private val form: Form[Boolean]     = new YesNoFormProvider().withPrefix("livingSettlor.countryOfNationalityYesNo")
