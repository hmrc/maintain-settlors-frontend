...
import pages.individual.living.{CountryOfResidencePage, NamePage}
...
class CountryOfResidenceControllerSpec extends SpecBase {
  ...
  private val form: Form[String] = new CountryFormProvider().withPrefix("livingSettlor.countryOfResidence")
