...
import pages.individual.living.{CountryOfNationalityUkYesNoPage, NamePage}
import play.api.data.Form
import play.api.inject.bind
import play.api.mvc.Call
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.individual.living.CountryOfNationalityUkYesNoView

class CountryOfNationalityUkYesNoControllerSpec extends SpecBase {

  private val form: Form[Boolean]     = new YesNoFormProvider().withPrefix("livingSettlor.countryOfNationalityUkYesNo")
