...
import pages.individual.living.{CountryOfNationalityPage, NamePage}
...
import views.html.individual.living.CountryOfNationalityView

class CountryOfNationalityControllerSpec extends SpecBase {

  private val form: Form[String]      = new CountryFormProvider().withPrefix("livingSettlor.countryOfNationality")
