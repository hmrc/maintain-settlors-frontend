...
import pages.individual.living.{CountryOfResidenceUkYesNoPage, NamePage}
...
class CountryOfResidenceUkYesNoControllerSpec extends SpecBase {
  ...
  private val form: Form[Boolean]     = new YesNoFormProvider().withPrefix("livingSettlor.countryOfResidenceUkYesNo")
