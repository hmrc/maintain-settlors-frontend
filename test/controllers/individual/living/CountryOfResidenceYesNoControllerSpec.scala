...
import pages.individual.living.{CountryOfResidenceYesNoPage, NamePage}
...
class CountryOfResidenceYesNoControllerSpec extends SpecBase {
  ...
  private val form: Form[Boolean] = new YesNoFormProvider().withPrefix("livingSettlor.countryOfResidenceYesNo")
