  ...
  "SessionExpired Controller" must {
    ...
    "redirect to the login url and have the continue and origin params present on a POST" in {
      ...
      redirectLocation(result).getOrElse(
        ""
      ) mustEqual "http://localhost:9949/auth-login-stub/gg-sign-in?continue=http%3A%2F%2Flocalhost%3A9781%2Ftrusts-registration&origin=maintain-settlors-frontend"
