      ...
      "Fully matched" when {
        ...
        "there are no other settlors" must {
          ...
          "Do you know date of death page -> Yes -> Date of death page" in
            navigator
              .nextPage(DateOfDeathYesNoPage, answers.set(DateOfDeathYesNoPage, true).success.value)
          ...
          "Do you know date of death page -> No -> Are there any additional settlors for the trust page" in
            navigator
              .nextPage(DateOfDeathYesNoPage, answers.set(DateOfDeathYesNoPage, false).success.value)
          ...
          "Date of death page -> Are there any additional settlors for the trust page" in
            navigator
              .nextPage(DateOfDeathPage, answers)
              .mustBe(controllers.individual.deceased.routes.AdditionalSettlorsYesNoController.onPageLoad())

          "Are there any additional settlors for the trust page -> Check details page" in
            navigator
              .nextPage(AdditionalSettlorsYesNoPage, answers)
        ...
        "there are other settlors" must {
          ...
          "Do you know date of death page -> Yes -> Date of death page" in
            navigator
              .nextPage(DateOfDeathYesNoPage, baseAnswers.set(DateOfDeathYesNoPage, true).success.value)
              .mustBe(controllers.individual.deceased.routes.DateOfDeathController.onPageLoad())

          "Do you know date of death page -> No -> Check details page" in
            navigator
              .nextPage(DateOfDeathYesNoPage, baseAnswers.set(DateOfDeathYesNoPage, false).success.value)
              .mustBe(controllers.individual.deceased.routes.CheckDetailsController.renderFromUserAnswers())

          "Date of death page -> Check details page" in
            navigator
              .nextPage(DateOfDeathPage, baseAnswers)
              .mustBe(controllers.individual.deceased.routes.CheckDetailsController.renderFromUserAnswers())
        }
      }
      ...
      "Not fully matched" when {
        ...
        "there are no other settlors" must {
          ...
          "Do you know date of birth page -> Yes -> Date of birth page" in
            navigator
              .nextPage(DateOfBirthYesNoPage, answers.set(DateOfBirthYesNoPage, true).success.value)
          ...
          "Do you know date of birth page -> No -> Do you know NINO page" in
            navigator
              .nextPage(DateOfBirthYesNoPage, answers.set(DateOfBirthYesNoPage, false).success.value)
          ...
          "Date of birth page -> Do you know NINO page" in
            navigator
              .nextPage(DateOfBirthPage, answers)
              .mustBe(controllers.individual.deceased.routes.NationalInsuranceNumberYesNoController.onPageLoad())
          ...
          "Do you know NINO page -> Yes -> NINO page" in
            navigator
              .nextPage(
                ...
                answers.set(NationalInsuranceNumberYesNoPage, true).success.value
              )
          ...
          "Do you know NINO page -> No -> Do you know address page" in
            navigator
              .nextPage(
                NationalInsuranceNumberYesNoPage,
                answers.set(NationalInsuranceNumberYesNoPage, false).success.value
              )
          ...
          "NINO page -> Are there any additional settlors for the trust page" in
            navigator
              .nextPage(NationalInsuranceNumberPage, answers)
              .mustBe(controllers.individual.deceased.routes.AdditionalSettlorsYesNoController.onPageLoad())

          "Do you know address page -> Yes -> Is address in UK page" in
            navigator
              .nextPage(AddressYesNoPage, answers.set(AddressYesNoPage, true).success.value)
          ...
          "Do you know address page -> No -> Are there any additional settlors for the trust page" in
            navigator
              .nextPage(AddressYesNoPage, answers.set(AddressYesNoPage, false).success.value)
              .mustBe(controllers.individual.deceased.routes.AdditionalSettlorsYesNoController.onPageLoad())

          "Is address in UK page -> Yes -> UK address page" in
            navigator
              .nextPage(LivedInTheUkYesNoPage, answers.set(LivedInTheUkYesNoPage, true).success.value)
          ...
          "Is address in UK page -> No -> Non-UK address page" in
            navigator
              .nextPage(LivedInTheUkYesNoPage, answers.set(LivedInTheUkYesNoPage, false).success.value)
        ...
        "there are other settlors" must {
          ...
          "Do you know date of birth page -> Yes -> Date of birth page" in
            navigator
              .nextPage(DateOfBirthYesNoPage, baseAnswers.set(DateOfBirthYesNoPage, true).success.value)
              .mustBe(controllers.individual.deceased.routes.DateOfBirthController.onPageLoad())

          "Do you know date of birth page -> No -> Do you know NINO page" in
            navigator
              .nextPage(DateOfBirthYesNoPage, baseAnswers.set(DateOfBirthYesNoPage, false).success.value)
              .mustBe(controllers.individual.deceased.routes.NationalInsuranceNumberYesNoController.onPageLoad())

          "Date of birth page -> Do you know NINO page" in
            navigator
              .nextPage(DateOfBirthPage, baseAnswers)
              .mustBe(controllers.individual.deceased.routes.NationalInsuranceNumberYesNoController.onPageLoad())
          ...
          "Do you know NINO page -> Yes -> NINO page" in
            navigator
              .nextPage(
                NationalInsuranceNumberYesNoPage,
                baseAnswers.set(NationalInsuranceNumberYesNoPage, true).success.value
              )
              .mustBe(controllers.individual.deceased.routes.NationalInsuranceNumberController.onPageLoad())
          ...
          "Do you know NINO page -> No -> Do you know address page" in
            navigator
              .nextPage(
                NationalInsuranceNumberYesNoPage,
                baseAnswers.set(NationalInsuranceNumberYesNoPage, false).success.value
              )
              .mustBe(controllers.individual.deceased.routes.AddressYesNoController.onPageLoad())

          "NINO page -> Check details page" in
            navigator
              .nextPage(NationalInsuranceNumberPage, baseAnswers)
              .mustBe(controllers.individual.deceased.routes.CheckDetailsController.renderFromUserAnswers())

          "Do you know address page -> Yes -> Is address in UK page" in
            navigator
              .nextPage(AddressYesNoPage, baseAnswers.set(AddressYesNoPage, true).success.value)
              .mustBe(controllers.individual.deceased.routes.LivedInTheUkYesNoController.onPageLoad())

          "Do you know address page -> No -> Check details page" in
            navigator
              .nextPage(AddressYesNoPage, baseAnswers.set(AddressYesNoPage, false).success.value)
              .mustBe(controllers.individual.deceased.routes.CheckDetailsController.renderFromUserAnswers())

          "Is address in UK page -> Yes -> UK address page" in
            navigator
              .nextPage(LivedInTheUkYesNoPage, baseAnswers.set(LivedInTheUkYesNoPage, true).success.value)
              .mustBe(controllers.individual.deceased.routes.UkAddressController.onPageLoad())

          "Is address in UK page -> No -> Non-UK address page" in
            navigator
              .nextPage(LivedInTheUkYesNoPage, baseAnswers.set(LivedInTheUkYesNoPage, false).success.value)
              .mustBe(controllers.individual.deceased.routes.NonUkAddressController.onPageLoad())

          "UK address page -> Check details page" in
            navigator
              .nextPage(UkAddressPage, baseAnswers)
              .mustBe(controllers.individual.deceased.routes.CheckDetailsController.renderFromUserAnswers())

          "Non-UK address page -> Check details page" in
            navigator
              .nextPage(NonUkAddressPage, baseAnswers)
              .mustBe(controllers.individual.deceased.routes.CheckDetailsController.renderFromUserAnswers())
        }
      }
    }
