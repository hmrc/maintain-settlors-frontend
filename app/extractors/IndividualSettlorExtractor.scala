...
import models.{
  Address, CombinedPassportOrIdCard, IdCard, NationalInsuranceNumber, NonUkAddress, Passport, UkAddress, UserAnswers,
  YesNoDontKnow
}
...
class IndividualSettlorExtractor extends SettlorExtractor[IndividualSettlor] {
  ...
  override def apply(
    ...
    super
      .apply(answers, individual, index, hasAdditionalSettlors)
