  ...
  def apply(userAnswers: UserAnswers, adding: Boolean, settlorName: String)
    ...
    def answerRows: Seq[AnswerRow] = {
      ...
      Seq(
        ...
        bound.passportDetailsQuestion(PassportDetailsPage, ProvisionalPage, "livingSettlor.passportDetails", Some(rts.PassportDetailsController.onPageLoad(mode).url)),
        ...
        bound.idCardDetailsQuestion(IdCardDetailsPage, ProvisionalPage, "livingSettlor.idCardDetails", Some(rts.IdCardDetailsController.onPageLoad(mode).url)),
        ...
        bound.passportOrIdCardDetailsQuestion(PassportOrIdCardDetailsPage, ProvisionalPage, "livingSettlor.passportOrIdCardDetails", Some(rts.PassportOrIdCardDetailsController.onPageLoad(mode).url)),
