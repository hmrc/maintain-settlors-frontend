...
import pages.individual.living.CountryOfNationalityYesNoPage
...
class CountryOfNationalityYesNoController @Inject()(
  ...
  private val form: Form[Boolean] = formProvider.withPrefix("livingSettlor.countryOfNationalityYesNo")
