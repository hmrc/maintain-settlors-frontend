    ...
    mapping(
        ...
        text("ukAddress.error.line1.required")
          .verifying(
            firstError(
              ...
              maxLength(addressMaxLength, "ukAddress.error.line1.length"),
        ...
        text("ukAddress.error.line2.required")
          .verifying(
            firstError(
              ...
              maxLength(addressMaxLength, "ukAddress.error.line2.length"),
      ...
      "line3" ->
        optional(text()
          .verifying(
            firstError(
              maxLength(addressMaxLength, "ukAddress.error.line3.length"),
      ...
      "line4" ->
        optional(text()
          .verifying(
            firstError(
              maxLength(addressMaxLength, "ukAddress.error.line4.length"),
